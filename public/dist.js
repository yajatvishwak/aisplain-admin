(function () {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		await axios$1.get("https://judgy.cfd/aisplain/api/crud-agent");
    		...
    		$$invalidate(
    			...
    			mediaRecorder.onstop = async function () {
    				...
    				if (resp && resp.audio) {
    					...
    					const audio = new Audio("https://judgy.cfd/aisplain/api/quickaudio/" + resp.audio);
    					audio.play();
    	...
    	async function playIntro() {
    		...
    		// );
    		// intro.play();
    		const res = await axios$1.get("https://judgy.cfd/aisplain/api/landingpage-talk/" + apikey);
